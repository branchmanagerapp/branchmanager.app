...
var MarketingPage = (function() {
  ...
  // ---------- Social (v1244: SocialPilot card moved to attic/; posting runs through Marketing → Accounts) ----------
  function renderSocial() {
    return card('<h3 style="margin:0 0 4px;font-size:16px;">📱 Social Media</h3>'
      + '<div style="font-size:12px;color:#64748b;">Posting runs through the Make webhook and native connections in Marketing → Accounts. Days from the field are approved in the Schedule.</div>');
  }
  ...
  return {
    ...
    // v655: setAnalyticsRange removed — AnalyticsWidget.setRange handles it now
  };
})();
