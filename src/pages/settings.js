...
var SettingsPage = {
  render: function() {
    ...
    // SENDGRID_API_KEY from before the v372 Resend migration) and the
    // signals it surfaced (Supabase ready, Stripe link present) now live
    // in the Cloud Health diagnostic + the Stripe integrations card.
    ...
    html += cardOpen('About Branch Manager', { icon: 'info' })
      ...
      +       '<div><a href="mailto:info@branchmanager.app" style="color:var(--accent);text-decoration:none;">info@branchmanager.app</a></div>'
      +     '</div>'
